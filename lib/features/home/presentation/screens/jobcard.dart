...
class JobcardScreen extends StatefulWidget {
  ...
  const JobcardScreen({super.key, this.fromTabIndex = 0});
...
class _JobcardScreenState extends State<JobcardScreen> {
  ...
  // get api
  Future<void> _getJobCardList() async {
    if (!mounted) return;
    ...
    // URL Building - সরাসরি typedDay ব্যবহার করুন
    String url = "${Urls.jobcardUrl}?year=$selectedYear&month=$selectedMonth";
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        ...
                                        child: Builder(
                                          builder: (context) {
                                            // 1. Ajker date ber kora (Year, Month, Day)
                                            ...
                                            return Text(
                                              ...
                                              style: TextStyle(
                                                fontSize: 10,
                                                // Jodi ajke hoy tahole Yellow, nahole Black
                                                color: isToday
                                                    ? Colors.blue
                                                    : Colors.black,
                                                fontWeight: isToday
                                                    ? FontWeight.bold
                                                    : FontWeight
                                                          .normal, // Optional: Bold korle aro bhalo dekhabe
                                              ),
                                            );
                                          },
                                        ),
